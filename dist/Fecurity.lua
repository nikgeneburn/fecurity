...
Vector2.new(774,481),SidebarWidth=67,PanelTop=17,PanelHeight=446,PanelWidth=212,PanelGap=18,PanelLeft=85,PanelRight=16,PanelBottom=18,Radius=0,FontSize=12,HeaderSize=11,RowHeight=40,SliderHeight=52,
DropdownHeight=72}function b.PanelX(c)return b.PanelLeft+(c-1)*(b.PanelWidth+b.PanelGap)end function b.PanelHeightFor(c)local d=c or b.WindowSize.Y if d==b.WindowSize.Y then return b.PanelHeight end
return math.max(80,d-b.PanelTop-b.PanelBottom)end function b.PanelLayout(c,d,e)local f=e or b.WindowSize.X if d==3 and f==b.WindowSize.X then return b.PanelX(c),c==3 and 213 or b.PanelWidth end local
g=math.max(1,f-b.PanelLeft-b.PanelRight)local h=b.PanelGap*math.max(d-1,0)local i=math.max(1,g-h)local j=math.floor(i/math.max(d,1))local k=i-j*math.max(d,1)local l=j+(c==d and k or 0)local m=b.
PanelLeft+(c-1)*(j+b.PanelGap)return m,l end return b end function a.m()local b=a.cache.m if not b then b={c=__modImpl()}a.cache.m=b end return b.c end end do local __modImpl=function()local b={}
function b.New(c,d,e)local f=Instance.new(c)if d then for g,h in pairs(d)do(f)[g]=h end end f.Parent=e return f end function b.Corner(c,d)local e=Instance.new('UICorner')e.CornerRadius=UDim.new(0,d or
0)e.Parent=c return e end function b.Stroke(c,d,e,f)local g=Instance.new('UIStroke')g.Color=d g.Transparency=e or 0 g.Thickness=f or 1 g.ApplyStrokeMode=Enum.ApplyStrokeMode.Border g.Parent=c return g
end function b.Padding(c,d,e,f,g)local h=Instance.new('UIPadding')h.PaddingLeft=UDim.new(0,d)h.PaddingTop=UDim.new(0,e)h.PaddingRight=UDim.new(0,f)h.PaddingBottom=UDim.new(0,g)h.Parent=c return h end
function b.List(c,d,e)local f=Instance.new('UIListLayout')f.FillDirection=d f.SortOrder=Enum.SortOrder.LayoutOrder f.Padding=UDim.new(0,e or 0)f.Parent=c return f end return b end function a.n()local
b=a.cache.n if not b then b={c=__modImpl()}a.cache.n=b end return b.c end end do local __modImpl=function()local b=game:GetService('UserInputService')local c={}function c.Attach(d,e)local f=false
local g=Vector2.zero local h=e.Position local i={}table.insert(i,d.InputBegan:Connect(function(j)if j.UserInputType~=Enum.UserInputType.MouseButton1 then return end f=true g=b:GetMouseLocation()h=e.
Position end))table.insert(i,b.InputEnded:Connect(function(j)if j.UserInputType==Enum.UserInputType.MouseButton1 then f=false end end))table.insert(i,b.InputChanged:Connect(function(j)if not f or j.
UserInputType~=Enum.UserInputType.MouseMovement then return end local k=b:GetMouseLocation()-g e.Position=UDim2.new(h.X.Scale,h.X.Offset+k.X,h.Y.Scale,h.Y.Offset+k.Y)end))return function()for j,k in
ipairs(i)do k:Disconnect()end end end return c end function a.o()local b=a.cache.o if not b then b={c=__modImpl()}a.cache.o=b end return b.c end end do local __modImpl=function()local b={}function b.
Display(c)if typeof(c)=='EnumItem'then return string.gsub((c).Name,'Insert','INS')end if typeof(c)=='Instance'then local d=c if d.UserInputType==Enum.UserInputType.MouseButton1 then return'M1'elseif d
...
AbsoluteSize.X-6,4)local j=h local k=d.Font if k==Enum.Font.Unknown then k=Enum.Font.GothamBold end for l=g,h,-1 do local m=b:GetTextSize(d.Text,l,k,Vector2.new(math.huge,math.huge))if m.X<=i then j=l
break end end d.TextSize=j end task.defer(Resize)d:GetPropertyChangedSignal('Text'):Connect(Resize)d:GetPropertyChangedSignal('AbsoluteSize'):Connect(Resize)return Resize end return c end function a.s
()local b=a.cache.s if not b then b={c=__modImpl()}a.cache.s=b end return b.c end end do local __modImpl=function()local b=a.e()local c={}function c.Apply(d,e)d.Font=b.Fonts.Main.Fallback if not e
...
return b.c end end do local __modImpl=function()local b=a.n()local c=a.q()local d=a.r()local e=a.s()local f=a.t()local g=a.m()local h={}h.__index=h function h.New(i)local j=setmetatable({Window=i,
Buttons={}},h)local k=(b.New('Frame',{Name='Sidebar',BackgroundColor3=i.Theme.Surface,BorderSizePixel=0,Position=UDim2.fromOffset(0,0),Size=UDim2.fromOffset(g.SidebarWidth,479),ZIndex=22},i.Root))j.
Stroke=b.Stroke(k,i.Theme.Border,0,1)j.Root=k local l=(b.New('Frame',{Name='SelectedTab',BackgroundColor3=i.Theme.Selected,BackgroundTransparency=1,BorderSizePixel=0,Position=UDim2.fromOffset(0,72),
Size=UDim2.fromOffset(g.SidebarWidth,64),ZIndex=23},k))j.SelectedTab=l local m=(b.New('ImageLabel',{Name='Logo',BackgroundTransparency=1,Position=UDim2.fromOffset(6,13),Size=UDim2.fromOffset(50,48),
ImageColor3=i.Theme.Accent,ZIndex=24},k))local n=d.Apply(m,i.Library.AssetCache,'Logo')local o=c.AccentVertical(m,i.Theme.Accent)j.Logo=m j.LogoGradient=o if not n then local p=(b.New('TextLabel',{
Name='LogoFallback',BackgroundTransparency=1,Position=UDim2.fromOffset(6,13),Size=UDim2.fromOffset(50,48),Text='F',ZIndex=25},k))e.ApplyText(p,i.Theme,28,i.Theme.Accent)f.Apply(p,i.Library.AssetCache)
p.TextXAlignment=Enum.TextXAlignment.Center j.LogoFallback=p end return j end function h.AddButton(i,j)local k=a.v().New(i.Window,j,#i.Buttons+1)table.insert(i.Buttons,k)return k end function h.
RefreshTheme(i)i.Root.BackgroundColor3=i.Window.Theme.Surface i.Stroke.Color=i.Window.Theme.Border i.SelectedTab.BackgroundColor3=i.Window.Theme.Selected i.Logo.ImageColor3=i.Window.Theme.Accent c.
SetAccent(i.LogoGradient,i.Window.Theme.Accent)if i.LogoFallback then i.LogoFallback.TextColor3=i.Window.Theme.Accent end end return h end function a.w()local b=a.cache.w if not b then b={c=__modImpl(
)}a.cache.w=b end return b.c end end do local __modImpl=function()local b=game:GetService('RunService')local c=a.n()local d={}d.__index=d local e=180 local f=-8E-2 local g=1.08 function d.New(h,i)
local j=setmetatable({Window=h,Flakes={},Elapsed=0,Visible=true},d)local k=(c.New('Frame',{Name='SnowLayer',BackgroundTransparency=1,BorderSizePixel=0,Position=UDim2.fromOffset(0,0),Size=UDim2.
fromScale(1,1),ZIndex=2},i))j.Root=k for l=0,e-1 do local m=((l*53)%100)/100 local n=m^1.8 local o=(l*23+math.floor(l/3)*11)%100 local p=2.4+n*13+(l%5)*0.18 local q=18-n*11+(l*7%5)local r=(l*0.47)%q
local s=math.round((((l*29)%120)-60)*(0.35+n*1.25))local t=0.1+n*0.56 local u=l%2==0 and 180 or-180 local v=(c.New('TextLabel',{Name='Flake'..tostring(l),BackgroundTransparency=1,BorderSizePixel=0,
Size=UDim2.fromOffset(p,p),Text='*',TextColor3=Color3.new(1,1,1),TextTransparency=1-t,TextSize=p,Font=Enum.Font.GothamBold,ZIndex=2},k))table.insert(j.Flakes,{Node=v,LeftPercent=o,Duration=q,Delay=r,
Drift=s,Spin=u})end j.Connection=b.RenderStepped:Connect(function(l)j:Step(l)end)return j end function d.Step(h,i)if not h.Visible then return end local j=h.Root.AbsoluteSize if j.X<=0 or j.Y<=0 then
return end h.Elapsed+=i for k,l in ipairs(h.Flakes)do local m=((h.Elapsed+l.Delay)%l.Duration)/l.Duration local n=(l.LeftPercent/100)*j.X+m*l.Drift local o=(f+m*(g-f))*j.Y l.Node.Position=UDim2.
fromOffset(n,o)l.Node.Rotation=m*l.Spin end end function d.SetVisible(h,i)h.Visible=i h.Root.Visible=i end function d.Destroy(h)if h.Connection then h.Connection:Disconnect()end if h.Root then h.Root:
Destroy()end end return d end function a.x()local b=a.cache.x if not b then b={c=__modImpl()}a.cache.x=b end return b.c end end do local __modImpl=function()local b={}b.__index=b b.Height=0 function b
.New(c,d,e)local f=setmetatable({Window=c,Root=d,Title=e.Title or'Fecurity',Subtitle=e.Subtitle or''},b)f:Apply()return f end function b.Apply(c)c.Root:SetAttribute('FecurityTitle',c.Title)c.Root:
SetAttribute('FecuritySubtitle',c.Subtitle)end function b.SetTitle(c,d,e)c.Title=d if e~=nil then c.Subtitle=e end c:Apply()end return b end function a.y()local b=a.cache.y if not b then b={c=
__modImpl()}a.cache.y=b end return b.c end end do local __modImpl=function()local b=a.j()local c={}function c.FadeIn(d)d.Visible=true d.BackgroundTransparency=1 b.Play(d,0.15,{BackgroundTransparency=0
})end function c.FadeOut(d)local e=b.Play(d,0.15,{BackgroundTransparency=1})e.Completed:Once(function()if d and d.Parent then d.Visible=false end end)end function c.PanelIn(d,e)local f=d.Position d.
Visible=true d.Position=f+UDim2.fromOffset(0,7)d.BackgroundTransparency=1 task.delay(e or 0,function()if d and d.Parent then b.Play(d,0.16,{Position=f,BackgroundTransparency=0})end end)end function c.
PanelOut(d,e)local f=d.Position task.delay(e or 0,function()if not d or not d.Parent then return end local g=b.Play(d,0.12,{Position=f+UDim2.fromOffset(0,7),BackgroundTransparency=1},Enum.EasingStyle.
Quad,Enum.EasingDirection.In)g.Completed:Once(function()if d and d.Parent then d.Visible=false d.Position=f d.BackgroundTransparency=0 end end)end)end return c end function a.z()local b=a.cache.z if
not b then b={c=__modImpl()}a.cache.z=b end return b.c end end do local __modImpl=function()local b=a.n()local c={}function c.Vertical(d,e)local f=b.List(d,Enum.FillDirection.Vertical,e or 0)f.
HorizontalAlignment=Enum.HorizontalAlignment.Left return f end function c.Horizontal(d,e)local f=b.List(d,Enum.FillDirection.Horizontal,e or 0)f.VerticalAlignment=Enum.VerticalAlignment.Center return
f end function c.ResizeToContent(d,e,f)local Update=function()d.Size=UDim2.new(d.Size.X.Scale,d.Size.X.Offset,0,e.AbsoluteContentSize.Y+(f or 0))end e:GetPropertyChangedSignal('AbsoluteContentSize'):
Connect(Update)task.defer(Update)end return c end function a.A()local b=a.cache.A if not b then b={c=__modImpl()}a.cache.A=b end return b.c end end do local __modImpl=function()local b=a.n()local c={}
c.__index=c function c.New(d,e,f)local g=setmetatable({Section=d,Window=d.Window,Library=d.Window.Library,Options=e,Flag=e.Flag,SkipFlag=e.SkipFlag==true,Value=e.Default,Callback=e.Callback,
ThemeUnbinds={}},c)g.Root=(b.New('Frame',{Name=e.Text or'Widget',BackgroundTransparency=1,BorderSizePixel=0,Size=UDim2.new(1,0,0,f),LayoutOrder=d:NextOrder(),ZIndex=30},d.Body))if g.Flag then g.
Library.FlagManager:Register(g.Flag,g,g.Value,g.SkipFlag)local h=g.Library.FlagManager:Get(g.Flag,nil)if h~=nil then g.Value=h end end g.FlagDestroyConnection=g.Root.Destroying:Connect(function()g:
UnregisterFlag()end)g.ThemeDestroyConnection=g.Root.Destroying:Connect(function()g:UnbindTheme()end)return g end function c.UnbindTheme(d)for e,f in ipairs(d.ThemeUnbinds)do pcall(f)end table.clear(d.
ThemeUnbinds)if d.ThemeDestroyConnection then d.ThemeDestroyConnection:Disconnect()d.ThemeDestroyConnection=nil end end function c.UnregisterFlag(d)if d.Flag then d.Library.FlagManager:Unregister(d.
Flag,d)end if d.FlagDestroyConnection then d.FlagDestroyConnection:Disconnect()d.FlagDestroyConnection=nil end end function c.Commit(d,e,f)d.Value=e d.Library.FlagManager:Set(d.Flag,e)if f~=false then
d.Library:RunCallback(d.Options.Text or'Widget',d.Callback,e,d.Alpha)end end function c.SetValue(d,e,f)d:Commit(e,f)end function c.Destroy(d)d:UnregisterFlag()d:UnbindTheme()if d.Root then d.Root:
Destroy()end end function c.BindTheme(d,e)if d.Window and d.Window.RegisterThemeBinding then local f=d.Window:RegisterThemeBinding(e)if f then table.insert(d.ThemeUnbinds,f)end end end function c.
...
ControlHover or q.ToggleOff o.BackgroundColor3=j.Value and q.Accent or q.ToggleKnobOff end)j:SetValue(j.Value,false)return j end function g.SetValue(h,i,j)local k=i==true h:Commit(k,j)local l=h.Window
.Theme f.Play(h.Track,0.12,{BackgroundColor3=k and l.ControlHover or l.ToggleOff})f.Play(h.Knob,0.12,{BackgroundColor3=k and l.Accent or l.ToggleKnobOff,Position=k and UDim2.fromOffset(13,2)or UDim2.
fromOffset(2,2)})end return g end function a.C()local b=a.cache.C if not b then b={c=__modImpl()}a.cache.C=b end return b.c end end do local __modImpl=function()local b=game:GetService(
'UserInputService')local c=a.B()local d=a.n()local e=a.s()local f=a.t()local g={}g.__index=g setmetatable(g,{__index=c})local Format=function(h,i)if h.Suffix then local j=h.Decimals and string.format(
...
local SetFromMouse=function()local r=b:GetMouseLocation().X-n.AbsolutePosition.X local s=math.clamp(r/math.max(n.AbsoluteSize.X,1),0,1)local t=i.Min+(i.Max-i.Min)*s local u=math.floor((t/i.Step)+0.5)*
i.Step j:SetValue(math.clamp(u,i.Min,i.Max))end j:Track(n.InputBegan:Connect(function(r)if r.UserInputType==Enum.UserInputType.MouseButton1 then q=true SetFromMouse()end end))j:Track(p.InputBegan:
Connect(function(r)if r.UserInputType==Enum.UserInputType.MouseButton1 then q=true end end))j:Track(b.InputEnded:Connect(function(r)if r.UserInputType==Enum.UserInputType.MouseButton1 then q=false end
end))j:Track(b.InputChanged:Connect(function(r)if q and r.UserInputType==Enum.UserInputType.MouseMovement then SetFromMouse()end end))j.DestroyConnection=j.Root.Destroying:Connect(function()j:
DisconnectInputs()end)j:BindTheme(function(r)l.TextColor3=r.Text m.TextColor3=r.Text n.BackgroundColor3=r.SliderTrack o.BackgroundColor3=r.Accent p.BackgroundColor3=r.Accent end)j:SetValue(j.Value,
false)return j end function g.Track(h,i)table.insert(h.Connections,i)return i end function g.DisconnectInputs(h)for i,j in ipairs(h.Connections)do j:Disconnect()end table.clear(h.Connections)if h.
DestroyConnection then h.DestroyConnection:Disconnect()h.DestroyConnection=nil end end function g.SetValue(h,i,j)local k=tonumber(i)or h.Options.Min k=math.clamp(k,h.Options.Min,h.Options.Max)h:
Commit(k,j)local l=(k-h.Options.Min)/math.max(h.Options.Max-h.Options.Min,1)h.Fill.Size=UDim2.new(l,0,0,2)h.Knob.Position=UDim2.new(l,0,0,1)h.ValueLabel.Text=Format(h.Options,k)end function g.Destroy(
h)h:DisconnectInputs()c.Destroy(h)end return g end function a.D()local b=a.cache.D if not b then b={c=__modImpl()}a.cache.D=b end return b.c end end do local __modImpl=function()local b=a.B()local c=a
.n()local d=a.s()local e=a.t()local f=a.j()local g={}g.__index=g setmetatable(g,{__index=b})local Contains=function(h,i)for j,k in ipairs(h)do if k==i then return true end end return false end local
Display=function(h)if type(h)=='table'then return#h>0 and table.concat(h,', ')or'None'end return tostring(h or'None')end function g.New(h,i)i.Values=i.Values or i.Options or{}local j=if i.Default~=nil
then i.Default else i.Value if i.Multi then i.Default=j if i.Default==nil then i.Default={}elseif type(i.Default)~='table'then i.Default={i.Default}end else i.Default=j or i.Values[1]or'None'end if i.
Multi and type(i.Default)~='table'then i.Default={i.Default}end local k=b.New(h,i,72)setmetatable(k,g)local l=k.Window.Theme local m=(c.New('TextLabel',{Name='Title',Size=UDim2.new(1,0,0,16),Text=i.
Text or'Dropdown',ZIndex=31},k.Root))d.ApplyText(m,l,10,l.Text)e.Apply(m,k.Library.AssetCache)local n=(c.New('TextLabel',{Name='Hint',Position=UDim2.fromOffset(0,15),Size=UDim2.new(1,0,0,14),Text=i.
Hint or'',ZIndex=31},k.Root))d.ApplyText(n,l,9,l.Hint)e.Apply(n,k.Library.AssetCache)local o=(c.New('TextButton',{Name='Box',AutoButtonColor=false,BackgroundColor3=l.Control,BorderSizePixel=0,Position
=UDim2.fromOffset(0,31),Size=UDim2.new(1,0,0,24),Text='',ZIndex=32},k.Root))k.Box=o c.Stroke(o,l.Border,0.45,1)local p=(c.New('TextLabel',{Name='Value',Position=UDim2.fromOffset(16,7),Size=UDim2.new(1
,-50,0,12),Text='',ZIndex=33},o))d.ApplyText(p,l,10,l.Text)e.Apply(p,k.Library.AssetCache)d.FitText(p,10,8)k.ValueLabel=p local q=(c.New('TextLabel',{Name='Arrow',AnchorPoint=Vector2.new(1,0),Position
=UDim2.new(1,-18,0,10),Size=UDim2.fromOffset(8,5),Text='v',ZIndex=33},o))d.ApplyText(q,l,8,l.Muted)e.Apply(q,k.Library.AssetCache)q.TextXAlignment=Enum.TextXAlignment.Center k.Arrow=q o.
MouseButton1Click:Connect(function()k:ToggleMenu()end)o.MouseEnter:Connect(function()f.Play(o,0.12,{BackgroundColor3=k.Window.Theme.ControlHover})end)o.MouseLeave:Connect(function()f.Play(o,0.12,{
BackgroundColor3=k.Window.Theme.Control})end)k.DestroyConnection=k.Root.Destroying:Connect(function()k:CloseMenu(true)end)k:BindTheme(function(r)m.TextColor3=r.Text n.TextColor3=r.Hint o.
BackgroundColor3=r.Control p.TextColor3=r.Text q.TextColor3=r.Muted k:RefreshRows()end)k:SetValue(k.Value,false)return k end function g.CloseMenu(h,i)local j=h.Menu if j then h.Menu=nil h.OptionRows=
nil if i then j:Destroy()else local k=f.Play(j,0.12,{Size=UDim2.fromOffset(j.AbsoluteSize.X,0),BackgroundTransparency=0.15},Enum.EasingStyle.Quad,Enum.EasingDirection.In)k.Completed:Connect(function()
if j and j.Parent then j:Destroy()end end)end end if h.Window.Dropdown==h then h.Window.Dropdown=nil end if h.Arrow and h.Arrow.Parent then if i then h.Arrow.Rotation=0 else f.Play(h.Arrow,0.12,{
Rotation=0})end end end function g.ToggleMenu(h)if h.Menu then h:CloseMenu()else h:OpenMenu()end end function g.OpenMenu(h)if h.Window.Dropdown and h.Window.Dropdown~=h then h.Window.Dropdown:
CloseMenu()end if h.Options.GetValues then local i,j=pcall(h.Options.GetValues)if i and type(j)=='table'then h.Options.Values=j end end h.Window.Dropdown=h local i=h.Window.Theme local j=h.Window.Root
.AbsolutePosition local k=h.Box.AbsolutePosition local l=22 local m=math.max(l,math.min(#h.Options.Values,7)*l)local n=(c.New('Frame',{Name='DropdownMenu',BackgroundColor3=i.Control,
BackgroundTransparency=0.15,BorderSizePixel=0,ClipsDescendants=true,Position=UDim2.fromOffset(k.X-j.X,k.Y-j.Y+h.Box.AbsoluteSize.Y+1),Size=UDim2.fromOffset(h.Box.AbsoluteSize.X,0),ZIndex=210},h.Window
.Overlay))c.Stroke(n,i.Border,0,1)h.Menu=n h.OptionRows={}f.Play(n,0.14,{Size=UDim2.fromOffset(h.Box.AbsoluteSize.X,m),BackgroundTransparency=0})f.Play(h.Arrow,0.14,{Rotation=180})local o=(c.New(
'ScrollingFrame',{Name='Options',Active=true,BackgroundTransparency=1,BorderSizePixel=0,CanvasSize=UDim2.fromOffset(0,#h.Options.Values*l),ScrollBarImageColor3=i.Accent,ScrollBarThickness=#h.Options.
Values>7 and 2 or 0,ScrollingDirection=Enum.ScrollingDirection.Y,Size=UDim2.fromScale(1,1),ZIndex=211},n))for p,q in ipairs(h.Options.Values)do local r=(c.New('TextButton',{Name='Option'..tostring(p),
AutoButtonColor=false,BackgroundColor3=i.Control,BackgroundTransparency=0,BorderSizePixel=0,Position=UDim2.fromOffset(0,(p-1)*l),Size=UDim2.new(1,-2,0,l),Text='',ZIndex=211},o))local s=nil local t=nil
if h.Options.Multi then s=(c.New('Frame',{Name='Indicator',BackgroundColor3=i.Accent,BackgroundTransparency=1,BorderSizePixel=0,Position=UDim2.fromOffset(13,7),Size=UDim2.fromOffset(7,7),ZIndex=212},r
))t=c.Stroke(s,i.Muted,0,1)end local u=(c.New('TextLabel',{Name='Label',Position=UDim2.fromOffset(h.Options.Multi and 30 or 16,0),Size=UDim2.new(1,h.Options.Multi and-46 or-32,1,0),Text=tostring(q),
ZIndex=212},r))d.ApplyText(u,i,10,i.Muted)e.Apply(u,h.Library.AssetCache)h.OptionRows[p]={Option=q,Row=r,Label=u,Indicator=s,IndicatorStroke=t}r.MouseEnter:Connect(function()f.Play(r,0.1,{
BackgroundColor3=i.ControlHover})end)r.MouseLeave:Connect(function()local v=if h.Options.Multi then Contains(h.Value,q)else h.Value==q if not v then f.Play(r,0.12,{BackgroundColor3=h.Window.Theme.
Control})end end)r.MouseButton1Click:Connect(function()f.Press(r,i.Control,i.ControlHover)if h.Options.Multi then local v=table.clone(h.Value)if Contains(v,q)then for w=#v,1,-1 do if v[w]==q then
table.remove(v,w)end end else table.insert(v,q)end h:SetValue(v)h:RefreshRows()else h:SetValue(q)h:CloseMenu()end end)end h:RefreshRows()end function g.SetValue(h,i,j)if h.Options.Multi and type(i)~=
'table'then i={i}end h:Commit(i,j)h.ValueLabel.Text=Display(i)end function g.SetValues(h,i,j)h.Options.Values=i or{}local k=j or h.Value if h.Options.Multi then local l=if type(k)=='table'then k else{
k}local m={}for n,o in ipairs(l)do if Contains(h.Options.Values,o)then table.insert(m,o)end end h:SetValue(m,false)elseif not Contains(h.Options.Values,k)then h:SetValue(h.Options.Values[1]or'None',
false)else h:SetValue(k,false)end if h.Menu then local l=h.Menu h.Menu=nil h.OptionRows=nil l:Destroy()h:OpenMenu()else h:RefreshRows()end end function g.RefreshRows(h)if not h.OptionRows then return
end local i=h.Window.Theme for j,k in ipairs(h.OptionRows)do local l=if h.Options.Multi then Contains(h.Value,k.Option)else h.Value==k.Option if k.Indicator then k.Indicator.BackgroundColor3=i.Accent
k.Indicator.BackgroundTransparency=l and 0 or 1 end if k.IndicatorStroke then k.IndicatorStroke.Color=l and i.Accent or i.Muted end k.Label.TextColor3=l and i.Accent or i.Muted k.Row.BackgroundColor3=
l and i.ControlHover or i.Control end if h.Menu then h.Menu.BackgroundColor3=i.Control end end function g.Destroy(h)h:CloseMenu(true)if h.DestroyConnection then h.DestroyConnection:Disconnect()h.
DestroyConnection=nil end b.Destroy(h)end return g end function a.E()local b=a.cache.E if not b then b={c=__modImpl()}a.cache.E=b end return b.c end end do local __modImpl=function()local b=a.B()local
c=a.n()local d=a.s()local e=a.t()local f=a.k()local g=a.j()local h={}h.__index=h setmetatable(h,{__index=b})function h.New(i,j)local k=b.New(i,j,j.Height or 40)setmetatable(k,h)local l=k.Window.Theme
local m=l.Accent local n=(c.New('TextButton',{Name='Button',AutoButtonColor=false,BackgroundColor3=m,BorderSizePixel=0,Position=UDim2.fromOffset(0,6),Size=UDim2.new(1,0,0,26),Text=j.Text or'BUTTON',
ZIndex=31},k.Root))d.ApplyText(n,l,10,l.Text)e.Apply(n,k.Library.AssetCache)n.TextXAlignment=Enum.TextXAlignment.Center d.FitText(n,10,9)k.Control=n k.BaseColor=m n.MouseButton1Down:Connect(function()
g.Play(n,0.08,{BackgroundColor3=f.Lighten(k.BaseColor,0.16)})end)n.MouseButton1Up:Connect(function()g.Play(n,0.12,{BackgroundColor3=k.BaseColor})end)n.MouseLeave:Connect(function()g.Play(n,0.12,{
BackgroundColor3=k.BaseColor})end)n.MouseButton1Click:Connect(function()k.Library:RunCallback(j.Text or'Button',k.Callback)end)k:BindTheme(function(o)k.BaseColor=o.Accent n.BackgroundColor3=k.
BaseColor n.TextColor3=o.Text end)return k end return h end function a.F()local b=a.cache.F if not b then b={c=__modImpl()}a.cache.F=b end return b.c end end do local __modImpl=function()local b=a.B()
local c=a.n()local d=a.s()local e=a.t()local f={}f.__index=f setmetatable(f,{__index=b})function f.New(g,h)h.Default=h.Default or''local i=b.New(g,h,52)setmetatable(i,f)local j=i.Window.Theme local k=
(c.New('TextLabel',{Name='Title',Size=UDim2.new(1,0,0,16),Text=h.Text or'Textbox',ZIndex=31},i.Root))d.ApplyText(k,j,10,j.Text)e.Apply(k,i.Library.AssetCache)local l=(c.New('TextBox',{Name='Box',
BackgroundColor3=j.Control,BorderSizePixel=0,ClearTextOnFocus=false,Position=UDim2.fromOffset(0,22),Size=UDim2.new(1,0,0,24),Text=tostring(i.Value),ZIndex=32},i.Root))d.ApplyText(l,j,10,j.Text)e.
Apply(l,i.Library.AssetCache)l.TextXAlignment=Enum.TextXAlignment.Left i.Box=l l.FocusLost:Connect(function()i:SetValue(l.Text)end)i:BindTheme(function(m)k.TextColor3=m.Text l.BackgroundColor3=m.
Control l.TextColor3=m.Text end)return i end function f.SetValue(g,h,i)g:Commit(tostring(h or''),i)if g.Box.Text~=g.Value then g.Box.Text=g.Value end end return f end function a.G()local b=a.cache.G
if not b then b={c=__modImpl()}a.cache.G=b end return b.c end end do local __modImpl=function()local b=game:GetService('UserInputService')local c=a.B()local d=a.n()local e=a.s()local f=a.t()local g=a.
p()local h={}h.__index=h setmetatable(h,{__index=c})function h.New(i,j)j.Default=j.Default or j.Value or'None'local k=j.Callback or j.OnPressed j.Callback=j.Changed or j.OnChanged local l=c.New(i,j,40
)setmetatable(l,h)l.ActivationCallback=k local m=l.Window.Theme local n=(d.New('TextLabel',{Name='Title',Size=UDim2.new(1,-92,0,16),Text=j.Text or'Keybind',ZIndex=31},l.Root))e.ApplyText(n,m,10,m.Text
)f.Apply(n,l.Library.AssetCache)local o=(d.New('TextLabel',{Name='Hint',Position=UDim2.fromOffset(0,15),Size=UDim2.new(1,-92,0,14),Text=j.Hint or'',ZIndex=31},l.Root))e.ApplyText(o,m,9,m.Hint)f.Apply(
o,l.Library.AssetCache)local p=(d.New('TextButton',{Name='Box',AutoButtonColor=false,AnchorPoint=Vector2.new(1,0),BackgroundColor3=m.Control,BorderSizePixel=0,Position=UDim2.new(1,0,0,1),Size=UDim2.
fromOffset(90,20),Text=tostring(l.Value),ZIndex=32},l.Root))e.ApplyText(p,m,10,m.Text)f.Apply(p,l.Library.AssetCache)p.TextXAlignment=Enum.TextXAlignment.Center e.FitText(p,10,8)l.Box=p p.
MouseButton1Click:Connect(function()l:Listen()end)l.ActivationConnection=b.InputBegan:Connect(function(q,r)if r or l.Listening then return end if g.IsActivation(q,l.Value)then l.Library:RunCallback(j.
Text or'Keybind',l.ActivationCallback,l.Value,q)end end)l.DestroyConnection=l.Root.Destroying:Connect(function()l:DisconnectInputs()end)l:BindTheme(function(q)n.TextColor3=q.Text o.TextColor3=q.Hint p
.BackgroundColor3=q.Control p.TextColor3=q.Text end)l:SetValue(l.Value,false)return l end function h.Listen(i)if i.Listening then return end i.Listening=true i.Box.Text='...'i.Box.BackgroundColor3=i.
Window.Theme.ControlHover if i.ListenConnection then i.ListenConnection:Disconnect()end i.ListenConnection=b.InputBegan:Connect(function(j,k)if k then return end i.ListenConnection:Disconnect()i.
ListenConnection=nil i.Listening=false i.Box.BackgroundColor3=i.Window.Theme.Control i:SetValue(g.Normalize(j))end)end function h.SetValue(i,j,k)i:Commit(g.Normalize(j or'None'),k)i.Box.Text=i.Value
end function h.DisconnectInputs(i)if i.ListenConnection then i.ListenConnection:Disconnect()i.ListenConnection=nil end if i.ActivationConnection then i.ActivationConnection:Disconnect()i.
ActivationConnection=nil end if i.DestroyConnection then i.DestroyConnection:Disconnect()i.DestroyConnection=nil end end function h.Destroy(i)i:DisconnectInputs()c.Destroy(i)end return h end function
a.H()local b=a.cache.H if not b then b={c=__modImpl()}a.cache.H=b end return b.c end end do local __modImpl=function()local b=a.k()local c={}c.Templates={'#ff0000','#5f90f6','#d8f368','#e1ae24',
'#3ad4bb','#fee2eb','#f25dab','#ffffff'}c.HueSequence=ColorSequence.new({ColorSequenceKeypoint.new(0,Color3.fromRGB(255,0,0)),ColorSequenceKeypoint.new(0.17,Color3.fromRGB(255,255,0)),
ColorSequenceKeypoint.new(0.33,Color3.fromRGB(0,255,0)),ColorSequenceKeypoint.new(0.5,Color3.fromRGB(0,255,255)),ColorSequenceKeypoint.new(0.67,Color3.fromRGB(0,0,255)),ColorSequenceKeypoint.new(0.83,
Color3.fromRGB(255,0,255)),ColorSequenceKeypoint.new(1,Color3.fromRGB(255,0,0))})function c.ToColorAlpha(d)if typeof(d)=='Color3'then return d,nil end if type(d)=='table'then local e,f=c.ToColorAlpha(
d.Color or d.Value)return e,tonumber(d.Alpha)or f end if type(d)=='string'then local e,f=b.ParseWithAlpha(d)return e or b.Hex(d),f end return Color3.new(1,1,1),nil end function c.AddGradient(d,e,f,g)
local h=Instance.new('UIGradient')h.Color=e if f then h.Transparency=f end h.Rotation=g or 0 h.Parent=d return h end return c end function a.I()local b=a.cache.I if not b then b={c=__modImpl()}a.cache
.I=b end return b.c end end do local __modImpl=function()local b=game:GetService('UserInputService')local c=a.B()local d=a.n()local e=a.s()local f=a.t()local g=a.k()local h=a.I()local i={}i.__index=i
setmetatable(i,{__index=c})function i.New(j,k)k.Default=k.Default or k.Value or Color3.new(1,1,1)local l=c.New(j,k,40)setmetatable(l,i)local m=l.Window.Theme l.PopupConnections={}l.Alpha=math.clamp(
tonumber(k.Alpha or k.DefaultAlpha)or 1,0,1)if l.Flag then local n=l.Flag..'.Alpha'l.AlphaFlag=n local o=l.Library.FlagManager:Get(n,nil)if o~=nil then l.Alpha=math.clamp(tonumber(o)or l.Alpha,0,1)end
l.Library.FlagManager:Register(n,{SetValue=function(p,q,r)l:SetAlpha(q,r)end},l.Alpha,l.SkipFlag)end local n=(d.New('TextLabel',{Name='Title',Size=UDim2.new(1,-44,0,16),Text=k.Text or'Color',ZIndex=31
},l.Root))e.ApplyText(n,m,10,m.Text)f.Apply(n,l.Library.AssetCache)local o=(d.New('TextLabel',{Name='Hint',Position=UDim2.fromOffset(0,15),Size=UDim2.new(1,-44,0,14),Text=k.Hint or'',ZIndex=31},l.Root
))e.ApplyText(o,m,9,m.Hint)f.Apply(o,l.Library.AssetCache)local p=(d.New('TextButton',{Name='Swatch',AutoButtonColor=false,AnchorPoint=Vector2.new(1,0),Position=UDim2.new(1,-1,0,5),Size=UDim2.
fromOffset(15,15),BackgroundColor3=(h.ToColorAlpha(l.Value)),BorderSizePixel=0,Text='',ZIndex=32},l.Root))d.Corner(p,8)d.Stroke(p,m.Border,0,1)l.Swatch=p p.MouseButton1Click:Connect(function()l:
TogglePicker()end)l.DestroyConnection=l.Root.Destroying:Connect(function()l:ClosePicker()if l.AlphaFlag then l.Library.FlagManager:Unregister(l.AlphaFlag)end end)l:BindTheme(function(q)n.TextColor3=q.
Text o.TextColor3=q.Hint if l.Popup then l.Popup.BackgroundColor3=q.Surface end if l.Apply then l.Apply.BackgroundColor3=q.Accent l.Apply.TextColor3=q.Text end if l.Hex then l.Hex.BackgroundColor3=q.
Control l.Hex.TextColor3=q.Text end end)l:SetValue(l.Value,false)return l end function i.DisconnectPopup(j)for k,l in ipairs(j.PopupConnections)do l:Disconnect()end table.clear(j.PopupConnections)end
function i.Track(j,k)table.insert(j.PopupConnections,k)return k end function i.ClosePicker(j)j:DisconnectPopup()j.DragTarget=nil if j.Popup then j.Popup:Destroy()j.Popup=nil j.Apply=nil j.Hex=nil j.
Preview=nil j.Square=nil j.SquareCursor=nil j.HueCursor=nil j.AlphaBar=nil j.AlphaCursor=nil end end function i.TogglePicker(j)if j.Popup then j:ClosePicker()else j:OpenPicker()end end function i.
CreateColorSquare(j,k,l)local m=(d.New('Frame',{Name='ColorSquare',BackgroundColor3=Color3.fromHSV(j.Hue,1,1),BorderSizePixel=0,Position=UDim2.fromOffset(10,40),Size=UDim2.fromOffset(182,182),ZIndex=
221},k))j.Square=m local n=(d.New('Frame',{Name='White',BackgroundColor3=Color3.new(1,1,1),BorderSizePixel=0,Size=UDim2.fromScale(1,1),ZIndex=222},m))h.AddGradient(n,ColorSequence.new(Color3.new(1,1,1
)),NumberSequence.new({NumberSequenceKeypoint.new(0,0),NumberSequenceKeypoint.new(1,1)}))local o=(d.New('Frame',{Name='Black',BackgroundColor3=Color3.new(0,0,0),BorderSizePixel=0,Size=UDim2.fromScale(
1,1),ZIndex=223},m))h.AddGradient(o,ColorSequence.new(Color3.new(0,0,0)),NumberSequence.new({NumberSequenceKeypoint.new(0,1),NumberSequenceKeypoint.new(1,0)}),90)local p=(d.New('Frame',{Name='Cursor',
BackgroundColor3=l.Accent,BorderSizePixel=0,Size=UDim2.fromOffset(7,7),ZIndex=224},m))d.Corner(p,4)d.Stroke(p,l.Text,0.4,1)j.SquareCursor=p j:Track(m.InputBegan:Connect(function(q)if q.UserInputType==
Enum.UserInputType.MouseButton1 then j.DragTarget='square'j:UpdateFromSquare()end end))end function i.CreateHueBar(j,k,l)local m=(d.New('Frame',{Name='Hue',BackgroundColor3=Color3.new(1,1,1),
BorderSizePixel=0,Position=UDim2.fromOffset(10,232),Size=UDim2.fromOffset(182,10),ZIndex=221},k))h.AddGradient(m,h.HueSequence)j.HueBar=m local n=(d.New('Frame',{Name='HueCursor',BackgroundColor3=l.
Accent,BorderSizePixel=0,Size=UDim2.fromOffset(7,7),ZIndex=222},m))d.Corner(n,4)d.Stroke(n,l.Text,0.4,1)j.HueCursor=n j:Track(m.InputBegan:Connect(function(o)if o.UserInputType==Enum.UserInputType.
MouseButton1 then j.DragTarget='hue'j:UpdateFromHue()end end))end function i.CreateAlphaBar(j,k,l)local m=(d.New('Frame',{Name='Alpha',BackgroundColor3=j.Value,BorderSizePixel=0,Position=UDim2.
fromOffset(10,248),Size=UDim2.fromOffset(182,10),ZIndex=221},k))h.AddGradient(m,ColorSequence.new(Color3.new(1,1,1)),NumberSequence.new({NumberSequenceKeypoint.new(0,1),NumberSequenceKeypoint.new(1,0)
}))j.AlphaBar=m local n=(d.New('Frame',{Name='AlphaCursor',BackgroundColor3=l.Accent,BorderSizePixel=0,Size=UDim2.fromOffset(7,7),ZIndex=222},m))d.Corner(n,4)d.Stroke(n,l.Text,0.4,1)j.AlphaCursor=n j:
Track(m.InputBegan:Connect(function(o)if o.UserInputType==Enum.UserInputType.MouseButton1 then j.DragTarget='alpha'j:UpdateFromAlpha()end end))end function i.CreateTemplates(j,k)local l=j.Window.Theme
for m,n in ipairs(h.Templates)do local o=(d.New('TextButton',{Name='Template'..tostring(m),AutoButtonColor=false,BackgroundColor3=g.Hex(n),BorderSizePixel=0,Position=UDim2.fromOffset(10+(m-1)*24,302),
Size=UDim2.fromOffset(16,16),Text='',ZIndex=221},k))d.Corner(o,8)d.Stroke(o,l.Text,0.8,1)j:Track(o.MouseButton1Click:Connect(function()j:SetValue(g.Hex(n))end))end end function i.OpenPicker(j)local k=
j.Window.Theme local l=j.Window.Root.AbsolutePosition local m=j.Swatch.AbsolutePosition local n=(d.New('Frame',{Name='ColorPickerPopup',BackgroundColor3=k.Surface,BorderSizePixel=0,Position=UDim2.
fromOffset(m.X-l.X-188,m.Y-l.Y+22),Size=UDim2.fromOffset(204,328),ZIndex=220},j.Window.Overlay))d.Stroke(n,k.Border,0,1)j.Popup=n j.Preview=(d.New('Frame',{Name='Preview',BackgroundColor3=j.Value,
BorderSizePixel=0,Position=UDim2.fromOffset(10,10),Size=UDim2.fromOffset(182,20),ZIndex=221},n))j:CreateColorSquare(n,k)j:CreateHueBar(n,k)j:CreateAlphaBar(n,k)local o=(d.New('TextBox',{Name='Hex',
BackgroundColor3=k.Control,BorderSizePixel=0,ClearTextOnFocus=false,Position=UDim2.fromOffset(10,268),Size=UDim2.fromOffset(112,24),Text=g.ToRgba(j.Value,j.Alpha),ZIndex=221},n))e.ApplyText(o,k,10,k.
Text)f.Apply(o,j.Library.AssetCache)local p=d.Stroke(o,k.Border,0,1)j.Hex=o j.HexStroke=p local q=(d.New('TextButton',{Name='Apply',AutoButtonColor=false,BackgroundColor3=k.Accent,BorderSizePixel=0,
Position=UDim2.fromOffset(130,268),Size=UDim2.fromOffset(62,24),Text='APPLY',ZIndex=221},n))e.ApplyText(q,k,10,k.Text)f.Apply(q,j.Library.AssetCache)q.TextXAlignment=Enum.TextXAlignment.Center j.Apply
=q j:Track(q.MouseButton1Click:Connect(function()local r,s=g.ParseWithAlpha(o.Text)p.Color=r and k.Border or g.Hex('#ff3f38')j:SetValue({Color=r or j.Value,Alpha=s})end))j:Track(o.FocusLost:Connect(
function()local r,s=g.ParseWithAlpha(o.Text)p.Color=r and k.Border or g.Hex('#ff3f38')j:SetValue({Color=r or j.Value,Alpha=s})end))j:Track(b.InputChanged:Connect(function(r)if r.UserInputType~=Enum.
UserInputType.MouseMovement then return end if j.DragTarget=='square'then j:UpdateFromSquare()elseif j.DragTarget=='hue'then j:UpdateFromHue()elseif j.DragTarget=='alpha'then j:UpdateFromAlpha()end
end))j:Track(b.InputEnded:Connect(function(r)if r.UserInputType==Enum.UserInputType.MouseButton1 then j.DragTarget=nil end end))j:CreateTemplates(n)j:UpdateVisuals()end function i.UpdateFromSquare(j)
if not j.Square then return end local k=b:GetMouseLocation()local l=j.Square.AbsolutePosition local m=j.Square.AbsoluteSize j.Saturation=math.clamp((k.X-l.X)/math.max(m.X,1),0,1)j.Brightness=1-math.
clamp((k.Y-l.Y)/math.max(m.Y,1),0,1)j:SetValue(Color3.fromHSV(j.Hue,j.Saturation,j.Brightness))end function i.UpdateFromHue(j)if not j.HueBar then return end local k=b:GetMouseLocation()local l=j.
HueBar.AbsolutePosition local m=j.HueBar.AbsoluteSize j.Hue=math.clamp((k.X-l.X)/math.max(m.X,1),0,1)j:SetValue(Color3.fromHSV(j.Hue,j.Saturation,j.Brightness))end function i.UpdateFromAlpha(j)if not
j.AlphaBar then return end local k=b:GetMouseLocation()local l=j.AlphaBar.AbsolutePosition local m=j.AlphaBar.AbsoluteSize j:SetAlpha((k.X-l.X)/math.max(m.X,1))end function i.SetAlpha(j,k,l)j.Alpha=
math.clamp(tonumber(k)or j.Alpha or 1,0,1)if j.Flag then j.Library.FlagManager:Set(j.Flag..'.Alpha',j.Alpha)end if l~=false then j.Library:RunCallback(j.Options.Text or'Color',j.Callback,j.Value,j.
Alpha)end j:UpdateVisuals()end function i.UpdateVisuals(j)local k=j.Value j.Swatch.BackgroundColor3=k j.Swatch.BackgroundTransparency=1-j.Alpha if j.Preview then j.Preview.BackgroundColor3=k j.Preview
...
Name=r.Id,Position=UDim2.fromOffset(19+t*94,300+s*22),Size=UDim2.fromOffset(70,20),Text=r.Id,ZIndex=31},n.Root))d.ApplyText(v,o,10,o.Muted)e.Apply(v,n.Library.AssetCache)end local q=(c.New('TextLabel'
,{Name='Help',Position=UDim2.fromOffset(2,358),Size=UDim2.new(1,0,0,18),Text='Edit hitboxes by clicking on a body part.',ZIndex=31},n.Root))d.ApplyText(q,o,11,o.Hint)e.Apply(q,n.Library.AssetCache)n:
...
fromScale(1,1),Text=h.Text or Format(h.Seconds or 0),ZIndex=31},i.Root))d.ApplyText(k,j,10,ToneColor(j,h.Tone))e.Apply(k,i.Library.AssetCache)i.Label=k i:BindTheme(function(l)k.TextColor3=ToneColor(l,
...
local k=(c.New('TextLabel',{Name='Text',Size=UDim2.fromScale(1,1),Text=h.Text or'',ZIndex=31},i.Root))d.ApplyText(k,j,10,ToneColor(j,h.Tone))e.Apply(k,i.Library.AssetCache)i.Text=k i:BindTheme(
...
Text=string.upper(i),ZIndex=24},n))c.ApplyText(o,h.Window.Theme,10,h.Window.Theme.Muted)d.Apply(o,h.Window.Library.AssetCache)m.Header=o end local o=(b.New('Frame',{Name='Body',BackgroundTransparency=
...
Notifications))b.Stroke(j,i.Border,0,1)b.Padding(j,12,8,12,8)local k=(b.New('TextLabel',{Name='Title',Size=UDim2.new(1,0,0,18),Text=h.Title or'Fecurity',ZIndex=402},j))c.ApplyText(k,i,12,i.Text)d.
...
l,i,11,i.Hint)d.Apply(l,g.Library.AssetCache)j.BackgroundTransparency=1 e.Play(j,0.16,{BackgroundTransparency=0})task.delay(h.Duration or 3,function()if j and j.Parent then local m=e.Play(j,0.16,{
...
j=(b.New('TextLabel',{Name='Title',Size=UDim2.new(1,0,0,22),Text=g.Title or'Fecurity',ZIndex=301},i))c.ApplyText(j,h,13,h.Text)d.Apply(j,f.Library.AssetCache)local k=(b.New('TextLabel',{Name='Body',
Position=UDim2.fromOffset(0,30),Size=UDim2.new(1,0,0,54),Text=g.Text or g.Message or'',TextWrapped=true,ZIndex=301},i))c.ApplyText(k,h,11,h.Hint)d.Apply(k,f.Library.AssetCache)return i end return e
